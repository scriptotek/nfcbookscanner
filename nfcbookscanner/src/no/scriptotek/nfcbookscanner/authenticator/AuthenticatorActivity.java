...
package no.scriptotek.nfcbookscanner.authenticator;

import org.json.JSONException;
import org.json.JSONObject;

import no.scriptotek.nfcbookscanner.BibsysApi;
import no.scriptotek.nfcbookscanner.Constants;
import no.scriptotek.nfcbookscanner.MainActivity;
import no.scriptotek.nfcbookscanner.R;
import no.scriptotek.nfcbookscanner.TaskListener;
import no.scriptotek.nfcbookscanner.BibsysApi.UserInfoTask;
 ...
 */
public class AuthenticatorActivity extends AccountAuthenticatorActivity implements TaskListener {
    ...
    public void handleLogin(View view) {
        ...
        if (TextUtils.isEmpty(mUsername) || TextUtils.isEmpty(mPassword)) {
            ...
            showProgress();
        	api = new BibsysApi(AuthenticatorActivity.this);
